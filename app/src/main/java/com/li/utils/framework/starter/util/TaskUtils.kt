package com.li.utils.framework.starter.util
...
object TaskUtils {
     ...
     * 当前进程名称
     * */
    private var mCurrentProcessName: String? = null
    
    /**
     * 通过读取系统文件来获取当前进程名
     * */
    private val currentProcessFromProc: String?
        get() {
            try {
                ...
                Log.w(TAG, "currentProcessFromProc： $e")
            }
            return null
        }
    ...
    fun getCurrentProcessName(context: Context): String? {
        val procName = mCurrentProcessName
        ...
        try {
            ...
            Log.w(TAG, "getCurProcessName: $e")
        }
        mCurrentProcessName = currentProcessFromProc
        return mCurrentProcessName
    }
    ...
    fun sortTasks(
        ...
        val dependSet: MutableSet<Int> = HashSet()
