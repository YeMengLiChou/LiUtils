...
/**
 * 分发的线程池，里面有 [ioExecutor][DispatcherExecutor.ioExecutor] 和 [cpuExecutor][DispatcherExecutor.cpuExecutor]
 *
 *
 * @author Gleamrise
...
object DispatcherExecutor {
    ...
    /** 获取 IO 线程池 */
    val ioExecutor: ExecutorService = Executors.newCachedThreadPool(mThreadFactory)
