package com.li.utils.framework.base.recyclerview
...
class DefaultDividerItemDecoration(context: Context, orientation: Int) : RecyclerView.ItemDecoration() {

    companion object {
        private val TAG = DefaultDividerItemDecoration::class.java.simpleName
