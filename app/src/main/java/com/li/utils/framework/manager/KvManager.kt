...
object KvManager {
     ...
     * 所有编码器
     * */
    private lateinit var encoders: Array<FastEncoder<*>>
     ...
     * 初始化 [KvManager]
     * @param application
     * @param encoders 需要加入的编码器
     * */
    fun init(application: Application, encoders: MutableList<FastEncoder<*>>) {
        initialized = true
        mApplication = application
        KvManager.encoders = encoders.apply { add(SetStringEncoder) }.toTypedArray()
     ...
     *  Set<String> 类型的编码器
     * */
    private object SetStringEncoder: FastEncoder<Set<String>> {
    ...
    /** 日志 */
    private object Logger : FastLogger {
...
//            e.printStackTrace()
     ...
     * 默认的加密
     * */
     private object DefaultCipher: FastCipher {
     ...
     */
     private class NumberCipher(key: ByteArray?) {
